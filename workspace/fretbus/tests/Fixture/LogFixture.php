...
class LogFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_log_buses1_idx' => ['type' => 'index', 'columns' => ['bus_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_log_buses1' => ['type' => 'foreign', 'columns' => ['bus_id'], 'references' => ['buses', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
